<?php
    ...
    $args = array(
        ...
        'display_name'         => __( 'Instantio Settings', 'wooinstant' ),
        ...
        'menu_title'           => __( 'Instantio', 'wooinstant' ),
        'page_title'           => __( 'Instantio - WooCommerce Instant / One Page Checkout Settings', 'wooinstant' ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array(
            array(
                'id'       => 'wi-active',
                'type'     => 'switch',
                'title'    => __( 'Active Instantio', 'wooinstant' ),
                'default'   => 1,
            ),
            array(
                'id'       => 'wi-show-oncart',
            ...
            array(
                ...
                'subtitle' => __( 'Actived window will open first when Instantio open', 'wooinstant' ),
                'options' => array(
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'subtitle' => __( 'Instantio Cart Panel Background Color', 'wooinstant' ),
                'default'  => '#f5f5f5',
                'transparent'  => false,
            ),
            array(
                ...
                'subtitle' => __( 'Instantio Cart Panel Toggler Background Color', 'wooinstant' ),
                'default'  => '#f5f5f5',
                'transparent'  => false,
            ),
            array(
            ...
            array(
                ...
                'subtitle' => __( 'Instantio Cart Panel Toggler Text/Icon Color', 'wooinstant' ),
                'default'  => '#272727',
                'transparent'  => false,
            ...
            array(
                ...
                'subtitle' => __( 'Instantio Cart Panel Toggler Text/Icon Hover Color', 'wooinstant' ),
                'default'  => '',
                'transparent'  => false,
                'required' => array('button-set-single','equals','1')
            ),
            array(
                ...
                'subtitle' => __( 'Instantio Quick View Panel Background Color', 'wooinstant' ),
                'default'  => '#f5f5f5',
                'transparent'  => false,
            ),
            array(
                ...
                'subtitle' => __( 'Control Instantio z-index from this option. More about <a target="_blank" href="https://css-tricks.com/almanac/properties/z/z-index/">z-index</a>', 'wooinstant' ),
                'default' => 999,
                'min' => 999,
                'step' => 5,
                'max' => 99999,
